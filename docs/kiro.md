...
1) **CLI command** (primary and only strategy)
   ...
   - Output is ANSI-decorated; MyAgentsBar strips escape sequences before parsing.
...
- `Sources/MyAgentsBarCore/Providers/Kiro/KiroProviderDescriptor.swift`
- `Sources/MyAgentsBarCore/Providers/Kiro/KiroStatusProbe.swift`
- `Sources/MyAgentsBar/Providers/Kiro/KiroProviderImplementation.swift`
