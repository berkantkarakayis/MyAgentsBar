---
summary: "Convert macOS .icon bundles to MyAgentsBar .icns via Scripts/build_icon.sh and ictool."
read_when:
  - Updating the MyAgentsBar app icon or asset pipeline
...
## Script
`Scripts/build_icon.sh ICON.icon MyAgentsBar [outdir]`
