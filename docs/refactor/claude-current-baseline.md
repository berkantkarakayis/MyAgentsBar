...
This document is the current-state parity reference for Claude behavior in MyAgentsBar.
...
This behavior is owned by `Sources/MyAgentsBarCore/Providers/Claude/ClaudeProviderDescriptor.swift`
...
- Expired credential owner behavior remains owner-specific:
  ...
  - `.myagentsbar`: direct refresh path,
...
This behavior is implemented in `Sources/MyAgentsBarCore/Providers/Claude/ClaudeUsageFetcher.swift`
...
- `Tests/MyAgentsBarTests/ClaudeBaselineCharacterizationTests.swift`
- `Tests/MyAgentsBarTests/ClaudeOAuthFetchStrategyAvailabilityTests.swift`
- `Tests/MyAgentsBarTests/ClaudeUsageTests.swift`
- `Tests/MyAgentsBarTests/TokenAccountEnvironmentPrecedenceTests.swift`
- `Tests/MyAgentsBarTests/SettingsStoreCoverageTests.swift`
