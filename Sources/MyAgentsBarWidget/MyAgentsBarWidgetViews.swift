...
struct MyAgentsBarUsageWidgetView: View {
    @Environment(\.widgetFamily) private var family
    let entry: MyAgentsBarWidgetEntry
...
struct MyAgentsBarHistoryWidgetView: View {
    @Environment(\.widgetFamily) private var family
    let entry: MyAgentsBarWidgetEntry
...
struct MyAgentsBarCompactWidgetView: View {
...
struct MyAgentsBarSwitcherWidgetView: View {
    @Environment(\.widgetFamily) private var family
    let entry: MyAgentsBarSwitcherEntry
