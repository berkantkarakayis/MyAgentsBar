...
let openAIDashboardScrapeScript = """
    ...
    (() => {
      ...
      const usageBreakdownJSON = (() => {
        try {
          if (window.__myagentsbarUsageBreakdownJSON) return window.__myagentsbarUsageBreakdownJSON;
          ...
          window.__myagentsbarUsageBreakdownJSON = json;
          window.__myagentsbarUsageBreakdownDebug = json ? null : JSON.stringify(debug);
          return json;
        } catch {
          return null;
        }
      ...
      const usageBreakdownDebug = (() => {
        try {
          return window.__myagentsbarUsageBreakdownDebug || null;
        } catch {
          return null;
        }
      })();
      ...
      try {
        ...
        if (header) {
          ...
          if (rows.length === 0 && !window.__myagentsbarDidScrollToCredits) {
            window.__myagentsbarDidScrollToCredits = true;
        ...
        } else if (rows.length === 0 && !window.__myagentsbarDidScrollToCredits && scrollHeight > viewportHeight * 1.5) {
