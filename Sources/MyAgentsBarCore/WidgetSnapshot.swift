...
public enum WidgetSnapshotStore {
    public static let appGroupID = "group.com.steipete.myagentsbar"
    ...
    private static func snapshotURL(bundleID: String?) -> URL? {
        ...
        let dir = base.appendingPathComponent("MyAgentsBar", isDirectory: true)
    ...
    private static func groupID(for bundleID: String?) -> String? {
        ...
        if bundleID.contains(".debug") {
            return "group.com.steipete.myagentsbar.debug"
        }
