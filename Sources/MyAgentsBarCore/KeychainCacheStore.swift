...
public enum KeychainCacheStore {
    ...
    private static let log = MyAgentsBarLog.logger(LogCategories.keychainCache)
    private static let cacheService = "com.steipete.myagentsbar.cache"
    private static let cacheLabel = "MyAgentsBar Cache"
