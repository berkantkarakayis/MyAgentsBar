...
func showAbout() {
    ...
    let credits = NSMutableAttributedString(string: "Berkant Karakayış — MIT License\n")
    credits.append(makeLink("LinkedIn", urlString: "https://www.linkedin.com/in/berkant-karakayis/"))
    credits.append(separator)
    credits.append(makeLink("Website", urlString: "https://berkant.vercel.app/#home"))
    credits.append(separator)
    credits.append(makeLink("Email", urlString: "mailto:berkantkarakayiss@gmail.com"))
    credits.append(NSAttributedString(string: "\nPowered by "))
    credits.append(makeLink("Berkant Karakayış", urlString: "https://berkant.vercel.app/#home"))
