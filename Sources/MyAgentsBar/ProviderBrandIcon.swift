...
enum ProviderBrandIcon {
    ...
    private static let resourceBundle: Bundle? = {
        // SwiftPM creates a MyAgentsBar_MyAgentsBar.bundle for resources in the MyAgentsBar target.
        if let bundleURL = Bundle.main.url(forResource: "MyAgentsBar_MyAgentsBar", withExtension: "bundle"),
