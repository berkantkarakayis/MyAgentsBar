...
struct DebugPane: View {
        ...
        ScrollView(.vertical, showsIndicators: true) {
            VStack(alignment: .leading, spacing: 20) {
                SettingsSection(title: "Logging") {
                    ...
                    HStack(alignment: .center, spacing: 12) {
                        ...
                        Picker("Verbosity", selection: self.$settings.debugLogLevel) {
                            ForEach(MyAgentsBarLog.Level.allCases) { level in
                    ...
                    Button {
                        NSWorkspace.shared.open(MyAgentsBarLog.fileLogURL)
                    } label: {
                    ...
                    caption: "Pick a pattern and replay it in the menu bar. \"Random\" keeps the existing behavior.")
                {
                    ...
                    Button {
                        NotificationCenter.default.post(name: .myagentsbarDebugBlinkNow, object: nil)
                    } label: {
    ...
    private var fileLogPath: String {
        MyAgentsBarLog.fileLogURL.path
    }
    ...
    private func replaySelectedAnimation() {
        ...
        NotificationCenter.default.post(
            name: .myagentsbarDebugReplayAllAnimations,
            object: nil,
