...
enum KeychainMigration {
    private static let log = MyAgentsBarLog.logger(LogCategories.keychainMigration)
    ...
    static let itemsToMigrate: [MigrationItem] = [
        MigrationItem(service: "com.steipete.MyAgentsBar", account: "codex-cookie"),
        MigrationItem(service: "com.steipete.MyAgentsBar", account: "claude-cookie"),
        MigrationItem(service: "com.steipete.MyAgentsBar", account: "cursor-cookie"),
        MigrationItem(service: "com.steipete.MyAgentsBar", account: "factory-cookie"),
        MigrationItem(service: "com.steipete.MyAgentsBar", account: "minimax-cookie"),
        MigrationItem(service: "com.steipete.MyAgentsBar", account: "minimax-api-token"),
        MigrationItem(service: "com.steipete.MyAgentsBar", account: "augment-cookie"),
        MigrationItem(service: "com.steipete.MyAgentsBar", account: "copilot-api-token"),
        MigrationItem(service: "com.steipete.MyAgentsBar", account: "zai-api-token"),
        MigrationItem(service: "com.steipete.MyAgentsBar", account: "synthetic-api-key"),
    ]
