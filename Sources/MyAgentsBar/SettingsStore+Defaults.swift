...
extension SettingsStore {
    ...
    var debugFileLoggingEnabled: Bool {
        ...
        set {
            ...
            MyAgentsBarLog.setFileLoggingEnabled(newValue)
        }
    }

    var debugLogLevel: MyAgentsBarLog.Level {
        get {
            let raw = self.defaultsState.debugLogLevelRaw
            return MyAgentsBarLog.parseLevel(raw) ?? .verbose
        }
        set {
            self.defaultsState.debugLogLevelRaw = newValue.rawValue
            self.userDefaults.set(newValue.rawValue, forKey: "debugLogLevel")
            MyAgentsBarLog.setLogLevel(newValue)
        }
    }
    ...
    var isVerboseLoggingEnabled: Bool {
        self.debugLogLevel.rank <= MyAgentsBarLog.Level.verbose.rank
    }
    ...
    private var claudeWebExtrasEnabledRaw: Bool {
        ...
        set {
            ...
            MyAgentsBarLog.logger(LogCategories.settings).info(
