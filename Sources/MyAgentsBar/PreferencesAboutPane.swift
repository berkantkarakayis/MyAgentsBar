...
struct AboutPane: View {
    ...
    var body: some View {
        VStack(spacing: 12) {
            ...
            VStack(alignment: .center, spacing: 10) {
                ...
                AboutLinkRow(icon: "globe", title: "Website", url: "https://berkant.vercel.app/#home")
                AboutLinkRow(icon: "envelope", title: "Email", url: "mailto:berkantkarakayiss@gmail.com")
            }
            .padding(.top, 8)
            ...
            Text("© 2026 Berkant Karakayış. MIT License.")
                .font(.footnote)
                .foregroundStyle(.secondary)
                .padding(.top, 4)
            HStack(spacing: 4) {
                Text("Powered by")
                    .font(.footnote)
                    .foregroundStyle(.secondary)
                Link("Berkant Karakayış", destination: URL(string: "https://berkant.vercel.app/#home")!)
                    .font(.footnote)
            }
    ...
    private func openProjectHome() {
        guard let url = URL(string: "https://berkant.vercel.app/#home") else { return }
