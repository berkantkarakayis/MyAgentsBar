...
if [[ -z "$version_content" ]]; then
  echo "<h2>MyAgentsBar $VERSION</h2>"
  echo "<p>Latest MyAgentsBar update.</p>"
  echo "<p><a href=\"https://github.com/steipete/MyAgentsBar/blob/main/CHANGELOG.md\">View full changelog</a></p>"
  exit 0
fi
