    ...
    func `fetch usage sets credits timeout and client headers`() async throws {
        ...
        OpenRouterStubURLProtocol.handler = { request in
            ...
            case "/api/v1/credits":
                ...
                #expect(request.value(forHTTPHeaderField: "HTTP-Referer") == "https://myagentsbar.example")
                #expect(request.value(forHTTPHeaderField: "X-Title") == "MyAgentsBar QA")
        ...
        let usage = try await OpenRouterUsageFetcher.fetchUsage(
            ...
            environment: [
                ...
                "OPENROUTER_HTTP_REFERER": " https://myagentsbar.example ",
                "OPENROUTER_X_TITLE": "MyAgentsBar QA",
            ])
